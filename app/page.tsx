    ...
    return (
        <div>
            ...
            <div className="flex pl-16 pt-3 gap-2 ">
                <button
                    className="bg-white cursor-pointer rounded-md duration-200 transition-all px-7 py-3 text-md text-black hover:bg-white/80"
                    onClick={() => setSol(true)}
                >
                    Solana
                </button>
                <button
                    className="bg-white rounded-md cursor-pointer duration-200 transition-all px-7 py-3 text-md text-black hover:bg-white/80"
                    onClick={() => setEth(true)}
                >
                    Ethereum
                </button>
